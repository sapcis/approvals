{
	"contents": {
		"a380d4e8-b53f-4ee5-9589-ffe298ed0895": {
			...
			"activities": {
				...
				"ef622bcc-f00f-4c9c-bacf-63561ec12bb9": {
					"name": "Подготовка проекта текстов объявлений и пригл."
				},
				...
				"d7ef630f-39ce-47e8-aaab-9b32797b25c0": {
					"name": "Проверка данных о согласующих"
				},
				...
				"c134df0e-9a3f-44ee-b7ab-a15649e7aa39": {
					"name": "Определение списка согласующих"
				},
				"0da8ddc7-120e-4cd8-b021-caadec4257d7": {
			...
			"sequenceFlows": {
				...
				"a0dee82f-8f5f-43b9-a599-4e9d4fb57be1": {
					"name": "SequenceFlow109"
				},
				"2699b55b-34a2-4428-bd16-3b8c942651c2": {
					"name": "SequenceFlow111"
				},
				"8eaabdf5-98b5-4481-852e-441c67cdfef0": {
		...
		"59ba7167-7b6e-45ee-bbbc-a9a5a646d83f": {
			"classDefinition": "com.sap.bpm.wfs.UserTask",
			"subject": "Разработка и отправка проекта приказа. Заявка № ${context.RequestId}",
			"priority": "MEDIUM",
			"isHiddenInLogForParticipant": false,
			"supportsForward": false,
			"userInterface": "sapui5://comsapbpmDocumentCentricTaskUI/com.sap.bpm.DocumentCentricTaskUI",
		...
		"9bba5869-c8c7-448a-a5cb-cec857e4327c": {
			"classDefinition": "com.sap.bpm.wfs.UserTask",
			"subject": "Изучение приказа. Заявка № ${context.RequestId}",
			"priority": "MEDIUM",
			"isHiddenInLogForParticipant": false,
			"supportsForward": false,
			"userInterface": "sapui5://comsapbpmDocumentCentricTaskUI/com.sap.bpm.DocumentCentricTaskUI",
		...
		"ef622bcc-f00f-4c9c-bacf-63561ec12bb9": {
			"classDefinition": "com.sap.bpm.wfs.UserTask",
			"subject": "Подготовка проекта текстов объявлений и пригл. Заявка № ${context.RequestId}",
			"priority": "MEDIUM",
			"isHiddenInLogForParticipant": false,
			"supportsForward": false,
			"userInterface": "sapui5://comsapbpmDocumentCentricTaskUI/com.sap.bpm.DocumentCentricTaskUI",
		...
		"df128d33-7600-4758-90b5-b7dde63bf693": {
			"classDefinition": "com.sap.bpm.wfs.UserTask",
			"subject": "Изучение текста объявления и приглашения. Заявка № ${context.RequestId}",
			"priority": "MEDIUM",
			"isHiddenInLogForParticipant": false,
			"supportsForward": false,
			"userInterface": "sapui5://comsapbpmDocumentCentricTaskUI/com.sap.bpm.DocumentCentricTaskUI",
		...
		"c134df0e-9a3f-44ee-b7ab-a15649e7aa39": {
			...
			"httpMethod": "POST",
			"requestVariable": "${context.GetApproversRule.Request}",
			"responseVariable": "${context.GetApproversRule.Response}",
			"id": "servicetask7",
			"name": "Определение списка согласующих"
		},
		"738332a6-ebfa-4a47-b1f8-17d046885b2f": {
		...
		"82c1e623-dc95-438c-8a23-3d038a6ac4ef": {
			...
			"targetRef": "8c1020ae-81a3-44de-92b2-ac01b3c2c54f"
		},
		"7d5af0f2-4d2e-4c60-9b7a-5a74ba79447d": {
			"classDefinition": "com.sap.bpm.wfs.SequenceFlow",
			"id": "sequenceflow54",
		...
		"4bc041ba-f02d-434c-94e4-cf1277e31f2e": {
			...
			"targetRef": "ddeefc0f-34a6-4976-859f-efc7d483e1f2"
		},
		"40903983-2008-45e0-ad73-8b6731aca326": {
			"classDefinition": "com.sap.bpm.wfs.SequenceFlow",
			"id": "sequencefl